document.addEventListener('DOMContentLoaded', function() {
  ...
  var postHelpList = function(){
    ...
    var helpKeyWords = [
      ...
      "- BarMapping - Map read data to reference using BWA MEM.",
      "- BarGenotype - BarGenotype mapped bam files using GATK.",
      "- BarHaplotype - Phase genotypes to haplotypes using WhatsHap.",
  ...
  var textReplies = function() {
    switch(textInputValueLowerCase){
      ...
      case "barmapping":
        clearInput();
        addTextToResults("Oke zo zou het dus werken<p>test");
        break;
